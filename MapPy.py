...
def ToDrawPicture(x, y, z, P0, P1, pictureSize, activeLevelDictionary, styles):
	...
	cursor.execute(sqlCities, (norm_P0[0], norm_P1[0], norm_P0[1], norm_P1[1], admin_level))
	DravAreaNames(draw, size, p0, cursor.fetchall(), 15)
	...
	if z > 4:
		...
		DravCities(draw, size, p0, cursor.fetchall(), 4, 15)
